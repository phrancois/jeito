...
$(VENV)/bin/django-admin: $(VENV)/bin/python /usr/bin/virtualenv /usr/lib/libpq.so /usr/include/python3.4/pyconfig.h /usr/include/libxml2/libxml/xmlversion.h /usr/bin/xslt-config
